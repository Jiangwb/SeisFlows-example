...
% shot to be removed, position
%shot_del=[1500 2700 3900 4500 5100 7500 9300 11100 11700 17100 18900 20100];
shot_del=[];
...
for is=1:ns
	...
	if (ismember(sx,shot_del))
		...
		filename = sprintf('./geometry_files/SOURCE_%06i',is-1-idel);
    	fid=fopen(filename,'w');
